// <copyright file="CircleInboxSendViewModel.cs" company="LeeftSamen B.V.">
...
{
    public class CircleInboxSendViewModel
    {
        /// <summary>
        ...
        /// </summary>
        public ICollection<CircleEmailMessage> SendEmailMessages { get; set; }
